...
import rex.tokens;
import rex.class_map;

using namespace RexTokens;
using lexer::INVALID_TOKEN;
using lexer::CONTINUE_TOKEN;

RexLexer::RexLexer(const std::u32string& content_, const std::string& fileName_, int fileIndex_) : lexer::Lexer(content_, fileName_, fileIndex_)
{
}

RexLexer::RexLexer(const char32_t* start_, const char32_t* end_, const std::string& fileName_, int fileIndex_) : lexer::Lexer(start_, end_, fileName_, fileIndex_)
{
}
