...
export module wing.split_container;
...
inline SplitterFlags operator|(SplitterFlags left, SplitterFlags right)
{
...
inline SplitterFlags operator~(SplitterFlags flags)
{
    return SplitterFlags(~int(flags));
}

struct SplitterCreateParams
{
...
struct SplitContainerCreateParams
{
...
class SplitContainer : public ContainerControl
{
public:
