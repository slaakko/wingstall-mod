...
export namespace wing {
    ...
    inline int DoubleClickWindowClassStyle()
    {
        return CS_DBLCLKS;
    }

    inline int DefaultChildWindowStyle()
    {
        return WS_CHILD | WS_VISIBLE | WS_CLIPSIBLINGS;
    }

    inline int HiddenChildWindowStyle()
    {
        return WS_CHILD | WS_CLIPSIBLINGS;
    }

    inline int DialogWindowStyle()
    {
        return WS_CAPTION | WS_DLGFRAME | WS_CLIPSIBLINGS;
    }

    inline int OverlappedWindowStyle()
    {
        return WS_OVERLAPPEDWINDOW;
    }

    inline Point DefaultLocation()
    {
        return Point(CW_USEDEFAULT, CW_USEDEFAULT);
    }

    inline Size DefaultSize()
    {
        return Size(CW_USEDEFAULT, CW_USEDEFAULT);
    }

    inline int DefaultMouseHoverMs()
    {
        return 300;
    }

    inline Size DefaultMouseHoverSize()
    {
        return Size(8, 8);
    }
    ...
    inline int64_t DefaultControlWindowClassBackgroundColor()
    {
        return COLOR_MENU;
    }

    inline Color DefaultControlBackgroundColor()
    {
    ...
    inline ControlFlags operator&(ControlFlags left, ControlFlags right)
    {
    ...
    inline ControlFlags operator~(ControlFlags flags)
    {
