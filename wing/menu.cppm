...
inline MenuFlags operator&(MenuFlags left, MenuFlags right)
{
...
inline MenuFlags operator~(MenuFlags menuFlags)
{
...
class MenuBar : public MenuControl
{
public:
    MenuBar();
...
class MenuBox : public MenuControl
{
public:
...
class ContextMenu : public MenuBox
{
public:
    ContextMenu();
    ~ContextMenu();
...
class MenuItemSeparator : public MenuItemBase
{
public:
    Padding DefaultPadding() const override;
    Size MeasureItem(Graphics& graphics, const Font& font, const StringFormat& format, int& maxShortcutWidth, int& childIndicatorWidth) override;
