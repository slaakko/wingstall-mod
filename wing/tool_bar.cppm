...
export module wing.tool_bar;

import wing.tool_tip;
...
inline ToolBarFlags operator|(ToolBarFlags left, ToolBarFlags right)
{
...
inline ToolBarFlags operator~(ToolBarFlags flags)
{
...
class ToolButtonBase : public Component
{
public:
    ToolButtonBase();
...
inline ToolButtonFlags operator|(ToolButtonFlags left, ToolButtonFlags right)
{
...
inline ToolButtonFlags operator~(ToolButtonFlags flags)
{
    return ToolButtonFlags(~int(flags));
}

struct ToolButtonCreateParams
{
...
class ToolButton : public ToolButtonBase
{
public:
...
struct TextToolButtonCreateParams
{
...
class TextToolButton : public ToolButton
{
public:
...
class ToolButtonSeparator : public ToolButtonBase
{
public:
    ToolButtonSeparator();
    void ComputeSize() override;
