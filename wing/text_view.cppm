...
inline TextViewFlags operator&(TextViewFlags left, TextViewFlags right)
{
...
inline TextViewFlags operator~(TextViewFlags flags)
{
...
public:
    ...
    void ExtendSelection(const lexer::SourcePos& start, const lexer::SourcePos& end);
...
private:
    ...
    lexer::SourcePos mouseSelectionStart;
    lexer::SourcePos mouseSelectionEnd;
