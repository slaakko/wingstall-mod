...
export module wing.icon_list_view;
...
struct IconListViewCreateParams
{
...
inline IconListViewFlags operator|(IconListViewFlags left, IconListViewFlags right)
{
...
inline IconListViewFlags operator~(IconListViewFlags flags)
{
...
class IconListView : public Control
{
public:
...
inline IconListViewItemFlags operator|(IconListViewItemFlags left, IconListViewItemFlags right)
{
...
inline IconListViewItemFlags operator~(IconListViewItemFlags flags)
{
    return IconListViewItemFlags(~int(flags));
}

class IconListViewItem : public Component
{
public:
